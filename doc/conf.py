...
latex_documents = [
  ('index', 'sphinxcontrib-jinjadomain.tex',
...
man_pages = [
    ('index', 'sphinxcontrib-jinjadomain',
     u'sphinxcontrib-jinjadomain Documentation',
     [u'Jaka Hudoklin'], 1)
]
...
texinfo_documents = [
  ('index', 'sphinxcontrib-jinjadomain',
   u'sphinxcontrib-jinjadomain Documentation', u'Jaka Hudoklin',
   'sphinxcontrib-jinjadomain', 'One line description of project.',
   'Miscellaneous'),
]
